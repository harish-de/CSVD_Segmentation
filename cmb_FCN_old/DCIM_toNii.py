...
os.chdir('/Volumes/Seagate Backup Plus Drive/Dataset-CMB/ADNI-CMBs/data/')
DIR = '/Volumes/Seagate Backup Plus Drive/Dataset-CMB/ADNI-CMBs/data/'

df = pd.read_csv('/Volumes/Seagate Backup Plus Drive/Dataset-CMB/ADNI-CMBs/meta/MAYOADIRL_MRI_MCH_08_15_19.csv', delimiter="\t")
...
for main_folder in os.listdir('.'):
    output = '/Volumes/Seagate Backup Plus Drive/Dataset-CMB/ADNI-CMBs/Output'
    if ((main_folder.endswith(".zip") or (main_folder.endswith(".csv"))) == False):
        os.chdir('/Volumes/Seagate Backup Plus Drive/Dataset-CMB/ADNI-CMBs/Output')
