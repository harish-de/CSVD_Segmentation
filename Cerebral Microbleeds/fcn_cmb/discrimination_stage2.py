...
def create_dset_screening_stage1():
    ...
    dset_train = joblib.load('data_pos_neg_fp.sav')
...
def save_checkpoint(state, count, filename='checkpoints\\checkpoint.pth.tar'):
    ...
    :return:
    """
    filename = 'checkpoints_discrimination_stage2\\checkpoint_' + str(count) + '.pth.tar'
...
def validate(val_loader, epoch_index):
    path = 'checkpoints_discrimination_stage2\\checkpoint_' + str(epoch_index) + '.pth.tar'
...
with open('discrimination_stage2_plot_loss.txt', 'w') as f:
